# Extracted from store/docs/sources/blogs/gated-delta-net.md by scripts/extract_blog_code.py
# Heading: ## Key Code > ### Chunk-parallel prefill reference (PyTorch)
# Original fence language: python
# See store/corpus/artifacts/blogs/gated-delta-net/code/PROVENANCE.yaml for origin + license metadata.
