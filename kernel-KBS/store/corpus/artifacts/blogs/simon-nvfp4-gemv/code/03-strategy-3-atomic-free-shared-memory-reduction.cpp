// Extracted from store/docs/sources/blogs/simon-nvfp4-gemv.md by scripts/extract_blog_code.py
...
// See store/corpus/artifacts/blogs/simon-nvfp4-gemv/code/PROVENANCE.yaml for origin + license metadata.
