// Extracted from store/docs/sources/blogs/yue-nvfp4-hackathon.md by scripts/extract_blog_code.py
...
// See store/corpus/artifacts/blogs/yue-nvfp4-hackathon/code/PROVENANCE.yaml for origin + license metadata.
