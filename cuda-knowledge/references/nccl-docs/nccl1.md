...
**Source:** https://docs.nvidia.com/deeplearning/nccl/user-guide/docs/nccl1.html

---

# Migrating from NCCL 1 to NCCL 2[](#migrating-from-nccl-1-to-nccl-2 "Permalink to this heading")
...
## Initialization[](#initialization "Permalink to this heading")
...
## Communication[](#communication "Permalink to this heading")
...
## Counts[](#counts "Permalink to this heading")

Counts provided as arguments are now of type size_t instead of integer.

## In-place usage for AllGather and ReduceScatter[](#in-place-usage-for-allgather-and-reducescatter "Permalink to this heading")

For more information, see “In-place Operations”.

## AllGather arguments order[](#allgather-arguments-order "Permalink to this heading")
