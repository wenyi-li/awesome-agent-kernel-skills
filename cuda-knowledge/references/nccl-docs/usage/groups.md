...
Related links:
  ...
  * [`ncclGroupStart()`](https://docs.nvidia.com/deeplearning/nccl/user-guide/docs/api/group.html#c.ncclGroupStart "ncclGroupStart")

  * [`ncclGroupEnd()`](https://docs.nvidia.com/deeplearning/nccl/user-guide/docs/api/group.html#c.ncclGroupEnd "ncclGroupEnd")


## Aggregated Operations (2.2 and later)[](#aggregated-operations-2-2-and-later "Permalink to this heading")
...
## Group Operation Ordering Semantics[](#group-operation-ordering-semantics "Permalink to this heading")
...
For example, the following code provides the correct order of the operations. In this example, _comm0_ and _comm1_ are duplicated independent communicators that include rank 0 and 1.
...
## Nonblocking Group Operation[](#nonblocking-group-operation "Permalink to this heading")
...
Related links:
  ...
  * [`ncclCommInitRankConfig()`](https://docs.nvidia.com/deeplearning/nccl/user-guide/docs/api/comms.html#c.ncclCommInitRankConfig "ncclCommInitRankConfig")
