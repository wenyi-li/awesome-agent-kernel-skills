...
**Source:** https://docs.nvidia.com/deeplearning/nccl/user-guide/docs/usage/streams.html

---

# CUDA Stream Semantics[](#cuda-stream-semantics "Permalink to this heading")
...
## Mixing Multiple Streams within the same ncclGroupStart/End() group[](#mixing-multiple-streams-within-the-same-ncclgroupstart-end-group "Permalink to this heading")
