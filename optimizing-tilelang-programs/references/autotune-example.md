# GEMM Autotune Example

Full source from TileLang repository `examples/gemm/example_gemm_autotune.py`.
Demonstrates the programmatic AutoTuner API with roller-based config generation.
