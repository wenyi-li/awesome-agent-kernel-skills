  ...
  * [1\. Release Notes](#)
    * [1.1. Release Notes](#id1)
      ...
      * [1.1.8. Older Versions](#older-versions)
        ...
        * [Updates in 2023.2.1](#updates-in-2023-2-1)
        * [Updates in 2023.2](#updates-in-2023-2)
        * [Updates in 2023.1.1](#updates-in-2023-1-1)
        * [Updates in 2023.1](#updates-in-2023-1)
        * [Updates in 2022.4.1](#updates-in-2022-4-1)
        * [Updates in 2022.4](#updates-in-2022-4)
        * [Updates in 2022.3](#updates-in-2022-3)
        * [Updates in 2022.2.1](#updates-in-2022-2-1)
        * [Updates in 2022.2](#updates-in-2022-2)
        * [Updates in 2022.1.1](#updates-in-2022-1-1)
        * [Updates in 2022.1](#updates-in-2022-1)
        * [Updates in 2021.3.1](#updates-in-2021-3-1)
        * [Updates in 2021.3](#updates-in-2021-3)
        * [Updates in 2021.2.8](#updates-in-2021-2-8)
        * [Updates in 2021.2.7](#updates-in-2021-2-7)
        * [Updates in 2021.2.6](#updates-in-2021-2-6)
        * [Updates in 2021.2.5](#updates-in-2021-2-5)
        * [Updates in 2021.2.4](#updates-in-2021-2-4)
        * [Updates in 2021.2.3](#updates-in-2021-2-3)
        * [Updates in 2021.2.2](#updates-in-2021-2-2)
        * [Updates in 2021.2.1](#updates-in-2021-2-1)
        * [Updates in 2021.2](#updates-in-2021-2)
        * [Updates in 2021.1.1](#updates-in-2021-1-1)
        * [Updates in 2021.1](#updates-in-2021-1)
        * [Updates in 2020.3.1](#updates-in-2020-3-1)
        * [Updates in 2020.3](#updates-in-2020-3)
        * [Updates in 2020.2.1](#updates-in-2020-2-1)
        * [Updates in 2020.2](#updates-in-2020-2)
        * [Updates in 2020.1.2](#updates-in-2020-1-2)
        * [Updates in 2020.1.1](#updates-in-2020-1-1)
        * [Updates in 2020.1](#updates-in-2020-1)
        * [Updates in 2019.5.3](#updates-in-2019-5-3)
        * [Updates in 2019.5.2](#updates-in-2019-5-2)
        * [Updates in 2019.5.1](#updates-in-2019-5-1)
        * [Updates in 2019.5](#updates-in-2019-5)
        * [Updates in 2019.4](#updates-in-2019-4)
        * [Updates in 2019.3.1](#updates-in-2019-3-1)
        * [Updates in 2019.3](#updates-in-2019-3)
        * [Updates in 2019.2](#updates-in-2019-2)
        * [Updates in 2019.1](#updates-in-2019-1)
    * [1.2. Known Issues](#known-issues)
    * [1.3. Support](#support)
      * [1.3.1. Platform Support](#platform-support)
      * [1.3.2. GPU Support](#gpu-support)
      * [1.3.3. Library Support](#library-support)
        * [OptiX](#optix)
        * [CUDA Tile](#cuda-tile)
      * [1.3.4. System Requirements](#system-requirements)
...
**General**
  ...
  * Added support for locking GPUs to boost clock instead of base on Ampere and newer GPU. Use the `boost` and `force-boost` [options](../NsightComputeCli/index.html#command-line-options-profile) on supported drivers.

  * [Warp sampling](../ProfilingGuide/index.html#warp-sampling) by default now focuses on the _Not Issued_ (`(_not_issued)`) variants of the metrics. This is to avoid pointing to source locations where warp stalls are mitigated by having sufficient numbers of warps during an issue cycle to hide latency.
  ...
  * Source page now displays [symbol labels](../NsightCompute/index.html#profiler-report-source-page-navigation): A new column for symbol labels has been added, and symbol labels are shown alongside addresses in SASS instruction disassembly. This change aligns the output with that of the nvdisasm tool.
...
**General**
  ...
  * Added support for CUDA 13.0. See the tool’s CUDA driver [system requirements](index.html#system-requirements).
  ...
  * Added [support](../NsightComputeCli/index.html#command-line-options-profile) for not importing SASS cubins into the report.


**NVIDIA Nsight Compute**

  * The [Source page](../NsightCompute/index.html#pre-defined-source-metrics) now shows the instruction category in SASS and the instruction mix for high-level source.

  * Added a new [instruction mix and scoreboard dependencies table](../NsightCompute/index.html#profiler-report-source-page-additional-tables) to the Source page.

  * Added improved tooltips to the [memory chart](../ProfilingGuide/index.html#memory-chart).

  * Added information on the GPC Constant Cache (GCC) and DSMEM atomics in the [memory tables](../ProfilingGuide/index.html#memory-tables).

  * The [Metric Details](../NsightCompute/index.html#tool-window-metric-details) tool window now shows the breakdown for [throughput metrics](../ProfilingGuide/index.html#metrics-entities).
  ...
  * Improved the [occupancy calculator](../NsightCompute/index.html#occupancy-calculator).


**NVIDIA Nsight Compute CLI**

  * Added the option [–forward-signals](../NsightComputeCli/index.html#command-line-options-launch) to transparently forward signals to the profiled application.
...
**NVIDIA Nsight Compute**
  ...
  * Added product-wide [search](../NsightCompute/index.html#tool-window-search) functionality via a new search bar and tool window.
  ...
  * Added source correlation [navigation controls](../NsightCompute/index.html#navigation) which allow navigation to the previous or next block of correlated lines.


**NVIDIA Nsight Compute CLI**

  * Added support for profiling [MPS applications](../ProfilingGuide/index.html#special-configurations-mps).

  * Added support for filtering kernels based on a [renamed kernels](../NsightComputeCli/index.html#kernel-renaming) configuration during profiling.


**Resolved Issues**

  * CUDA Graphs in the [Resources View](../NsightCompute/index.html#tool-window-resources) use the current UI theme.
...
**General**
  ...
  * [Range Replay](../ProfilingGuide/index.html#range-replay) and [app-range replay](../ProfilingGuide/index.html#application-range-replay) are now supporting the collection of instruction-level source metrics.
...
**NVIDIA Nsight Compute**
  ...
  * Added interactive tooltips to [Details](../NsightCompute/index.html#profiler-report-details-page) and [Source](../NsightCompute/index.html#profiler-report-source-page) pages. An interactive tooltip can be used to compare different baselines. Its content can be copied to the clipboard using the copy icon button.

  * CUDA [Green Contexts support](../NsightCompute/index.html#green-contexts-support) is improved by showing TPC mask information in the Launch Statistics section, the [Resources](../NsightCompute/index.html#tool-window-resources) tool window, and on the [Session page](../NsightCompute/index.html#session-page).

  * Added heatmap to the [Source Comparison](../NsightCompute/index.html#source-comparison) document to visualize the source code differences.

  * Added _Diff By_ drop down menu to the [Source Comparison](../NsightCompute/index.html#source-comparison) document in the _SASS_ view, this allows you to choose the diff basis based on either _Opcode_ or _Full Instruction_.

  * Performance improvements in _SASS_ view.

  * The [Resources View](../NsightCompute/index.html#tool-window-resources) for CUDA Graphs can now visualize the graph structure directly in a new _Chart_ mode.

  * The [Memory Chart](../ProfilingGuide/index.html#memory-chart) now supports zoom and pan.

  * The [Metric Details](../NsightCompute/index.html#tool-window-metric-details) tool window now shows PM sampling metrics from the timeline as context switched.

  * Improved the performance for deploying to target systems over [remote connections](../NsightCompute/index.html#remote-connections).


**NVIDIA Nsight Compute CLI**

  * Added experimental support for profiling [MPS applications](../ProfilingGuide/index.html#special-configurations-mps).
...
**General**
  ...
  * Added support for cuMemBatchDecompressAsync API in the [Range Replay](../ProfilingGuide/index.html#range-replay).
...
**NVIDIA Nsight Compute**
  ...
  * The [source page](../NsightCompute/index.html#profiler-report-source-page-navigation) has improved search with support for regular expression- and value-based lookups.

  * Added support to set a [Source View Profile](../NsightCompute/index.html#profiler-report-source-page-profiles) as the default profile to apply it automatically while opening a report.

  * Added hyperlinks for the line numbers and inline function addresses in the [Inline Table](../NsightCompute/index.html#additional-tables). This enabled you to quickly jump to the respective line number in the Source view and address in the SASS view. Added a new column Source File in the [Inline Table](../NsightCompute/index.html#additional-tables) to show the file name to which source belongs.

  * The [memory chart](../ProfilingGuide/index.html#memory-chart) can indicate or hide inactive elements.

  * Chart tooltips on the Details page now show more relevant information when a specific value is hovered.

  * [Roofline charts](../ProfilingGuide/index.html#roofline) now support showing the formula for ridge point calculation in the [metric details](../NsightCompute/index.html#tool-window-metric-details) tool window.

  * The [occupancy calculator](../NsightCompute/index.html#occupancy-calculator) now considers the impact of block barriers for Hopper-architecture and newer GPUs. It also has improved controls to adjust input values.

  * The [remote connections](../NsightCompute/index.html#remote-connections) dialog now supports placeholders to deploy files to e.g. user-specific directories on the target system.


**NVIDIA Nsight Compute CLI**

  * Added new `--nvtx-push-pop-scope` [command line option](../NsightComputeCli/index.html#command-line-options-profile) which allows to set push pop range scope process wide.
...
**Resolved Issues**
  ...
  * On CUDA 12.7 drivers, [context switch trace](../ProfilingGuide/index.html#pm-sampling) can now filter events more precisely to the profiled CUDA context, even when profiling in containers.

  * [NVTX filtering](../NsightComputeCli/index.html#nvtx-filtering) now properly supports start/end ranges that start and end in different threads.
...
**NVIDIA Nsight Compute**
  ...
  * Disabled the [Acceleration Structure Viewer](../NsightCompute/index.html#acceleration-structure-viewer) on Linux (aarch64 and aarch64 sbsa) as the rendering view may cause a crash of the Nsight Compute UI. The functionality will be restored in a future version.
...
**NVIDIA Nsight Compute**
  ...
  * In [Source Comparison](../NsightCompute/index.html#source-comparison) document, added synchronized horizontal scrolling support across both sides for frozen columns.

  * Added hyperlinks for section and rule files in the [Metric Selection](../NsightCompute/index.html#metric-selection) tool window.
  ...
  * Improved Progress Log window in [Start Activity Dialog](../NsightCompute/index.html#connection-dialog) to show progress status of files being deployed to the remote host machine.
...
**General**
  ...
  * Added support for collecting [Python Call Stacks](../NsightCompute/index.html#profiler-report-nvtx-page) alongside native ones to better understand the context of a workload in Python applications.
...
**NVIDIA Nsight Compute**
  ...
  * Redesigned the [report header](../NsightCompute/index.html#profiler-report-header) for easier access to all report pages. All actions are now sorted into clearly labeled buttons. The focused result selection was integrated into the current row. When adding the current result as a baseline, the row itself is updated to reflect this, instead of showing a separate one.

  * Redesigned [Source Page](../NsightCompute/index.html#profiler-report-source-page) and [Source Comparison](../NsightCompute/index.html#source-comparison) controls to allow more vertical space.

  * The [Source Page](../NsightCompute/index.html#profiler-report-source-page) and [Source Comparison](../NsightCompute/index.html#source-comparison) Navigate By dropdowns can be linked to the respective other view. Changing column names from one dropdown will change it in the other view, too. This applies only if a column is also available in the second view.

  * Added Inline Table support in the [Source Comparison](../NsightCompute/index.html#source-comparison) document to each side separately.
  ...
  * The [Acceleration Structure Viewer](../NsightCompute/index.html#acceleration-structure-viewer) can now compute ray-geometry intersection and traversal timing heatmaps.

  * Added support for ignoring directories in the section search folder.

  * Added support for specifying [custom metric descriptions](../CustomizationGuide/index.html#custom-descriptions) in section files.
...
**General**
  ...
  * Reduced the number of passes required for collecting [PM sampling](../ProfilingGuide/index.html#pm-sampling) sections.
  ...
  * Added a new optional [PmSampling_WarpStates](../ProfilingGuide/index.html#sections-and-rules) section for understanding warp stall reasons over the workload duration.

  * Added a new rule for detecting load imbalances.

  * Improved the performance of graph-level profiling on new drivers.

  * Updated the [metrics compatibility](../ProfilingGuide/index.html#compatibility) table for OptiX cmdlists and instruction-level SASS metrics.

  * Improved PM sampling results by dynamically recollecting metrics to avoid outlier pass groups. Use the new [pm-sampling-max-passes](../NsightComputeCli/index.html#pm-sampling) option to control the maximum number of dynamically replayed passes.
...
**NVIDIA Nsight Compute**
  ...
  * Added SASS view and Source Markers support in [Source Comparison](../NsightCompute/index.html#source-comparison).

  * Improved [Source Comparison](../NsightCompute/index.html#source-comparison) diff visualization by adding empty lines on other side of inserted/deleted lines.

  * The Source page [column chooser](../NsightCompute/index.html#profiler-report-source-page-metrics) can now be opened directly from the Navigation drop down.

  * Added support to update a [source-page profile](../NsightCompute/index.html#profiles).

  * Added a [Launch Details](../NsightCompute/index.html#tool-window-launch-details) tool window for showing information about individual launches within larger workloads like OptiX command lists.

  * Added support for CUDA Green Contexts in the [Resources](../NsightCompute/index.html#tool-window-resources) tool window, the Launch Statistics section and the report header.

  * Property metrics can now be queried in the Metric Details window.

  * Added support to show if a CUDA Graph kernel node is device-side updatable in the [Resources](../NsightCompute/index.html#tool-window-resources) tool window.
...
**Resolved Issues**
  ...
  * Fixed that [Live Register](../NsightCompute/index.html#profiler-report-source-page-metrics) values would be too high for some workloads.
...
**Resolved Issues**
  ...
  * Fixed collection of context switch data during [PM Sampling](../ProfilingGuide/index.html#pm-sampling) when using [Range Replay](../ProfilingGuide/index.html#range-replay).
...
**General**
  ...
  * NVIDIA Nsight Compute now supports collecting many metrics by [sampling the GPU’s performance monitors (PM)](../ProfilingGuide/index.html#pm-sampling) periodically at fixed intervals. The results can be visualized on a [timeline](../NsightCompute/index.html#details-page).
  ...
  * Rule outputs are prioritized to improve the accuracy of estimated speedups. The [Summary](../NsightCompute/index.html#summary-page) page now shows the most actionable optimization advices when a result row is selected.
...
**NVIDIA Nsight Compute**
  ...
  * Added support to see the source files of two profile results side by side using [Source Comparison](../NsightCompute/index.html#source-comparison). This allows you to quickly identify source differences and understand changes in metric values.

  * The [Summary](../NsightCompute/index.html#summary-page) page is now the default page when a report is opened. Previous behavior can be enabled in the [options](../NsightCompute/index.html#profile) dialog.

  * On the [Summary](../NsightCompute/index.html#summary-page) and [Raw](../NsightCompute/index.html#raw-page) pages, values from all/selected rows are automatically aggregated in the column header for applicable metrics. Selected individual cells are aggregated in the bottom status bar.

  * Added `Launch Name` and `Device` options in the filter dialog launched by `Apply Filters` button in the [report header](../NsightCompute/index.html#profiler-report-header).

  * Added support for [source view profiles](../NsightCompute/index.html#profiles) that persist the Source page configuration and allow you to re-apply it to other reports.

  * The [Metric Details](../NsightCompute/index.html#metric-details) tool window now supports querying metrics beyond the current report by using the `chip:<chipname>` tag in the search.

  * Added support for _CUDA Graph Edge Data_ (such as port and dependency type) and _CUDA Graph Conditional Handles_ in the [Resources](../NsightCompute/index.html#resources) tool window.

  * The [Acceleration Structure Viewer](../NsightCompute/index.html#acceleration-structure-viewer) and [Resources](../NsightCompute/index.html#resources) tool window now support OptiX Opacity Micromaps.
...
**NVIDIA Nsight Compute**
  ...
  * Added a visual indication of scale of the metric value changes when the baselines are used. The background bars in the table cells of the Details Page allow to quickly identify which metrics values increased or decreased the most. The color scheme can be configured in the [Baselines tool window](../NsightCompute/index.html#tool-window-baselines).
  ...
  * Added support for allowing users to configure properties on [Summary Page](../NsightCompute/index.html#profiler-report-summary-page) using [Metrics/Properties profile option](../NsightCompute/index.html#options-profile).

  * Added percentage bars on [Summary Page](../NsightCompute/index.html#profiler-report-summary-page).
...
**General**
  ...
  * Added a new [app-range](../ProfilingGuide/index.html#application-range-replay) replay mode to profile ranges without API capture by relaunching the entire application multiple times.
  ...
  * The equivalent of the [high-level Python report interface](../CustomizationGuide/index.html#python-report-interface-high-level) is now available in rule files.


**NVIDIA Nsight Compute**

  * Added support for profiling individual metrics in [Interactive Profile activity](../NsightCompute/index.html#connection-activity-interactive). A new input field for metrics was added in the [Metric Selection](../NsightCompute/index.html#tool-window-sections-info) tool window.

  * Files on remote systems can be opened directly from the [menu](../NsightCompute/index.html#main-menu).

  * Metric- and section-related entries in the menu, [Profile activity](../NsightCompute/index.html#connection-activity-non-interactive) and [Metric Selection](../NsightCompute/index.html#tool-window-sections-info) tool window were renamed to make them more clear.

  * CPU and GPU [NUMA topology metrics](../ProfilingGuide/index.html#metrics-reference) can be collected on applicable systems. Topology information is shown in a new [NUMA Affinity section](../ProfilingGuide/index.html#sections-and-rules).

  * Added content-aware suggestions to the Details page to provide suggestions based on the selected profiling options.

  * Added support for [re-resolving source files](../NsightCompute/index.html#profiler-report-source-page-navigation) on the Source page.
  ...
  * Added support to search missing CUDA source files to permanently import into the report using [Source Lookup options](../NsightCompute/index.html#options-source-lookup) in the [Interactive Profile activity](../NsightCompute/index.html#connection-activity-interactive).

  * The [source page](../NsightCompute/index.html#profiler-report-source-page-metrics) now shows metric values as percentages by default. New buttons are added to support switching between different value modes.


**NVIDIA Nsight Compute CLI**

  * Added support for config files in the current working or user directory to set default ncu parameters. See the [General options](../NsightComputeCli/index.html#command-line-options-general) for more details.

  * Added `--range-filter`[command line option](../NsightComputeCli/index.html#command-line-options-console-output) which allows to select subset of enabled profile ranges.

  * Added new `--source-folders`[command line option](../NsightComputeCli/index.html#command-line-options-profile) that allows to recursively search for missing CUDA source files to permanently import into the report.
...
**General**
  ...
  * Added support for profiling [CUDA graphs](https://docs.nvidia.com/cuda/cuda-driver-api/group__CUDA__GRAPH.html#group__CUDA__GRAPH) as complete workloads instead of as single kernel nodes. Enable this using the _Graph Profiling_ option in the [activities](../NsightCompute/index.html#connection-dialog). Similarly to [range replay](../ProfilingGuide/index.html#range-replay) results, selected metrics are not available when profiling graphs.


  * Added support for profiling on Windows Subsystem for Linux (WSL2). See the [System Requirements](index.html#system-requirements) for more details.
...
**NVIDIA Nsight Compute**
  ...
  * The [Source page](../NsightCompute/index.html#profiler-report-source-page) now loads disassembly and static analysis results asynchronously in the background.

  * Added a new [Metric Details](../NsightCompute/index.html#tool-window-metric-details) tool window to inspect metric information such as raw value, unit, description or instance values. Open the tool window and select a metric on the _Details_ or _Raw_ page or lookup any metric in the focused report directly in the tool window’s search bar.
  ...
  * Simplified the command line generated by the [Profile activity](../NsightCompute/index.html#connection-activity-non-interactive).

  * Reduced the number of steps required to re-run the [Profile activity](../NsightCompute/index.html#connection-activity-non-interactive).

  * The way to rename [Baselines](../NsightCompute/index.html#baselines) in-place has been improved.

  * The [Resources](../NsightCompute/index.html#tool-window-resources) tool window now shows the CUDA Dynamic Parallelism state for CUDA functions and modules.
  ...
  * All OptiX build, instance and geometry flags can be viewed in the [Acceleration Structure Viewer](../NsightCompute/index.html#acceleration-structure-viewer).
...
**NVIDIA Nsight Compute CLI**
  ...
  * Added support to print section body item metrics on the details page with the new `--print-details`[command line option](../NsightComputeCli/index.html#command-line-options-console-output).

  * Added support to select what to show in Metric Name column on the details page with the new `--print-metric-name`[command line option](../NsightComputeCli/index.html#command-line-options-console-output).
...
**General**
  ...
  * Added support for [OptiX 7.6](index.html#library-support-optix).
  ...
  * Added [Metrics Reference](../ProfilingGuide/index.html#metrics-reference) in the documentation that lists metrics not available through `--query-metrics`.

  * Reduced the overhead of collecting SASS-patching based metrics.

  * On [Multi-Instance GPU (MIG)](../ProfilingGuide/index.html#special-configurations-mig) configurations, NVIDIA Nsight Compute cannot lock clocks anymore. Users are expected to lock clocks externally using nvidia-smi.
...
**NVIDIA Nsight Compute CLI**
  ...
  * Added a documentation section on supported [environment variables](../NsightComputeCli/index.html#environment-variables).
...
**General**
  ...
  * Added Linux (aarch64 sbsa) as a supported [host platform](index.html#platform-support).

  * The NVIDIA Nsight Compute CLI stores the command line arguments, which can be viewed in the [Session](../NsightCompute/index.html#profiler-report-session-page) report page.

  * Added an API to query the version of the [Python Report](../CustomizationGuide/index.html#python-report-interface) and [NvRules](../NvRulesAPI/index.html#abstract) interfaces.

  * Added an API to query the PTX in the [Python Report](../CustomizationGuide/index.html#python-report-interface) and [NvRules](../NvRulesAPI/index.html#abstract) interfaces.


**NVIDIA Nsight Compute**

  * The [Acceleration Structure Viewer](../NsightCompute/index.html#acceleration-structure-viewer) allows inspection of acceleration structures built using the OptiX API for debugging and performance optimization.

  * The [Source page](../NsightCompute/index.html#profiler-report-source-page) column chooser now supports to enable or disable groups of metrics. Note that not all metrics are enabled anymore by default to make the view easier to use.

  * The [Resources](../NsightCompute/index.html#tool-window-resources) tool window now links to the exact target resource instances for _CUDA_ resource types.

  * The [Resources](../NsightCompute/index.html#tool-window-resources) tool window now shows the instanced nodes for CUDA graphs.

  * The [Resources](../NsightCompute/index.html#tool-window-resources) tool window now shows the loading state and number of loaded functions for _CUDA Modules_.

  * The [Resources](../NsightCompute/index.html#tool-window-resources) tool window now shows the graph node enablement state for applicable instanced graph nodes.

  * The [Resources](../NsightCompute/index.html#tool-window-resources) tool window now shows the graph node priorities for instanced kernel graph nodes.
  ...
  * Added [keyboard shortcuts](../NsightCompute/index.html#quick-start-navigate-report) to navigate between the pages in a report.

  * The behavior for selecting sets and sections is now consistent between the [Sections/Rules Info window](../NsightCompute/index.html#tool-window-sections-info) and the [non-interactive profile activity](../NsightCompute/index.html#quick-start-non-interactive).
...
**NVIDIA Nsight Compute CLI**
  ...
  * Added support for collecting [sampling-based](../ProfilingGuide/index.html#sampling) warp stalls in range replay mode.

  * Added regex support in [NVTX filtering](../NsightComputeCli/index.html#nvtx-filtering).
...
**Resolved Issues**
  ...
  * Fixed missing to flush UVM buffers before taking memory checkpoints during [Range Replay](../ProfilingGuide/index.html#range-replay).

  * Fixed tracking of memory during [Range Replay](../ProfilingGuide/index.html#range-replay), if the CUDA context has any device mapped memory allocations.

  * Fixed the maximum available shared memory sizes in the [Occupancy Calculator](../NsightCompute/index.html#occupancy-calculator) for NVIDIA Ampere GPUs.

  * Fixed that the shared memory usage of the kernel is incorrectly initialized when opening the [Occupancy Calculator](../NsightCompute/index.html#occupancy-calculator) from a profile report.
...
**General**
  ...
  * Added a new [Range Replay](../ProfilingGuide/index.html#range-replay) mode to profile ranges of multiple, concurrent kernels. Range replay is available in the NVIDIA Nsight Compute CLI and the non-interactive Profile activity.
  ...
  * The [NvRules API](../NvRulesAPI/index.html#abstract) now supports querying action names using different function name bases (e.g. demangled).


**NVIDIA Nsight Compute**

  * The default [report page](../NsightCompute/index.html#profiler-report-pages) is now chosen automatically when opening a report.

  * Added coverage for ECC (Error Correction Code) operations in the L2 Cache table of the Memory Analysis section.

  * Added a new [L2 Evict Policies](../ProfilingGuide/topics/memory-tables-l2-evict-policy.html) table to the Memory Analysis section.

  * The [Occupancy Calculator](../NsightCompute/index.html#occupancy-calculator) now updates automatically when the input changes.

  * Added new metric _Thread Instructions Executed_ to the Source page.

  * Added tooltips to the [Register Dependency](../NsightCompute/index.html#profiler-report-source-page) columns in the Source page to identify the associated register more conveniently.
...
**NVIDIA Nsight Compute CLI**
  ...
  * Added support to resolve CUDA source files in the `--page source` output with the new `--resolve-source-file`[command line option](../NsightComputeCli/index.html#command-line-options-console-output).
...
**General**
  ...
  * Added new `IAction::sass_by_pc` function to the [NvRules API](../NvRulesAPI/index.html#abstract).

  * The [Python-based report interface](../CustomizationGuide/index.html#python-report-interface) is now available for Windows and macOS hosts, too.
...
**NVIDIA Nsight Compute**
  ...
  * Added support for new remote profiling [SSH connection and authentication options](../NsightCompute/index.html#remote-connections) as well as local SSH configuration files.

  * Added an [Occupancy Calculator](../NsightCompute/index.html#occupancy-calculator) which can be opened directly from a profile report or as a new activity. It offers feature parity to the CUDA Occupancy Calculator [spreadsheet](http://docs.nvidia.com/cuda/cuda-occupancy-calculator/index.html).

  * Added new [Baselines tool window](../NsightCompute/index.html#tool-window-baselines) to manage (hide, update, re-order, save/load) baseline selections.
  ...
  * The [Memory Workload Analysis Chart](../ProfilingGuide/index.html#memory-chart) can be configured to show throughput values instead of transferred bytes.
...
**NVIDIA Nsight Compute CLI**
  ...
  * Added support for printing source/metric content with the new `--page source` and `--print-source`[command line options](../NsightComputeCli/index.html#command-line-options-console-output).
...
**General**
  ...
  * Reduced the memory overhead when loading reports in the [Python Report Interface](../CustomizationGuide/index.html#python-report-interface).
...
**General**
  ...
  * Added support for profiling on [NVIDIA virtual GPUs](https://www.nvidia.com/en-us/data-center/virtual-gpu-technology/) (vGPUs) on an upcoming GRID/vGPU release.

  * Added a new [Python-based report interface](../CustomizationGuide/index.html#python-report-interface) for interacting with report files from Python scripts.
  ...
  * Renamed several `memory_*` metrics used on the _Source_ page, to better reflect the measured value. See the [Source page](../NsightCompute/index.html#profiler-report-source-page) documentation for more details.


**NVIDIA Nsight Compute**

  * Added support for opening [cubin files](https://docs.nvidia.com/cuda/cuda-binary-utilities/index.html#cuda-binary) in a [Standalone Source Viewer](../NsightCompute/index.html#cubin-viewer) without profiling the application.
  ...
  * [Memory tables](../ProfilingGuide/index.html#memory-tables) show tooltips for cells with derived metric calculations.
  ...
  * Added new columns for visualizing register dependencies in the SASS view of the [Source page](../NsightCompute/index.html#profiler-report-source-page).
...
**NVIDIA Nsight Compute CLI**
  ...
  * Added environment variable [NV_COMPUTE_PROFILER_DISABLE_STOCK_FILE_DEPLOYMENT=1](../NsightComputeCli/index.html#environment-variables) to skip deployment of section and rule files.
...
**General**
  ...
  * Added support for the [OptiX 7 API](index.html#library-support-optix).
  ...
  * NVTX states can now be accessed via the [NvRules API](../NvRulesAPI/index.html#abstract).
...
**NVIDIA Nsight Compute CLI**
  ...
  * Added file-based [application replay](../ProfilingGuide/index.html#application-replay) as the new default application replay mode. File-based replay uses a temporary file for keeping replay data, instead of allocating them in memory. This keeps the required memory footprint close to constant, independent of the number of profiled kernels. Users can switch between buffer modes using the `--app-replay-buffer` option.
...
**Resolved Issues**
  ...
  * Fixed that NVTX ranges named using their payloads can be used in [NVTX filtering](../NsightComputeCli/index.html#nvtx-filtering) expressions.
...
**General**
  ...
  * Added support for _derived metrics_ in section files. Derived metrics can be used to create new metrics based on existing metrics and constants. See the [Customization Guide](../CustomizationGuide/index.html#section-derived-metrics) for details.
...
**General**
  ...
  * Added documentation for memory charts and tables in the [Profiling Guide](../ProfilingGuide/index.html#memory-chart).
...
**General**
  ...
  * The [Kernel Profiling Guide](../ProfilingGuide/index.html#abstract) was added to the documentation
...
**Resolved Issues**
  ...
  * Fixed metric _thread_inst_executed_true_ to derive from _smsp_not_predicated_off_thread_inst_executed_ on Volta+ GPUs
...
**General**
  ...
  * Added support for _smsp__sass_*_ metrics on Volta and newer GPUs

  * The _launch__occupancy_limit_shared_mem_ now reports the device block limit if no shared memory is used by the kernel
...
**Resolved Issues**
  ...
  * Fixed an illegal memory access when collecting _sass__*_histogram_ metrics for applications using PyTorch on Pascal GPUs

  * Fixed an issue when attempting to collect all _smsp__*_ metrics on Volta and newer GPUs
  ...
  * Fixed that certain _smsp__warp_cycles_per_issue_stall*_ metrics returned negative values on Pascal GPUs
...
For example, specifying only option `--quiet` extracts the installer archive without any output to the console, but still prompts for user interaction during the installation. To install NVIDIA Nsight Compute without any console output nor any user interaction, please specify `--quiet -- -noprompt`.
  ...
  * See also the [System Requirements](index.html#system-requirements) for more installation instructions.


**Launch and Connection**

  * Launching applications on remote targets/platforms is not supported for several combinations. See [Platform Support](index.html#platform-support) for details. Manually launch the application using command line `ncu --mode=launch` on the remote system and connect using the UI or CLI afterwards.
...
**Profiling and Metrics**
  ...
  * Collecting device-level metrics, such as the NVLink metrics (`nvl*`), is not supported on [NVIDIA virtual GPUs](https://www.nvidia.com/en-us/data-center/virtual-gpu-technology/) (vGPUs).
  ...
  * Profiling on [NVIDIA live-migrated virtual machines](https://www.nvidia.com/en-us/data-center/virtualization/virtual-gpu-migration/) is not supported and can result in undefined behavior.
  ...
  * Data collected using [PM Sampling](../ProfilingGuide/index.html#pm-sampling) across multiple passes may not align perfectly in the timeline, even with context switch filtering applied.
...
The [Acceleration Structure Viewer](../NsightCompute/index.html#acceleration-structure-viewer) for OptiX traversable handles currently has the following limitations:
...
Nsight Compute requires a CUDA driver that is [compatible](https://docs.nvidia.com/deploy/cuda-compatibility) with CUDA 13. In addition, certain features may require a specific minimum driver version.
...
The Linux (x86_64) NVIDIA Nsight Compute package can be used and should be installed directly within WSL2. Remote profiling to and from WSL2 works equivalently to regular Linux (x86_64) hosts and targets, as long as it’s accessible via SSH. Access to NVIDIA GPU Performance Counters must be enabled in the NVIDIA Control Panel of the Windows host. See also the [CUDA on WSL User Guide](https://docs.nvidia.com/cuda/wsl-user-guide/index.html).
