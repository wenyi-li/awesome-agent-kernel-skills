...
def tl_sparse_mla_topk_reducesum_impl(
    ...
    ReduceSum = T.empty(reducesum_shape, accum_dtype)
...
def sparse_mla_topk_reducesum_interface(
    ...
    reducesum = tl_sparse_mla_topk_reducesum_impl(
        q, kv, topk_indices, lse, offsets, token_indices, heads=heads, dim=dim_v, tail_dim=tail_dim, topk=topk
    )
